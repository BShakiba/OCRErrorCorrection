...
def process_file(paras):
    ...
    out_z = open(out_fn + '.mt', 'w')                    # output file for manual transcription
    ...
    out_z_info = open(out_fn + '.mt.info', 'w')
    cur_line_no = 0
    cur_group = 0
    for line in content:
